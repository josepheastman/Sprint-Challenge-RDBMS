...
RDBMS is the database software itself, whereas SQL is a language you use to query the database.

1. Why do tables need a `primary key`?

To uniquely identify each record in a table, in the event of a duplicate name the only distinction would the unique primary key.
...
To create a third table, and to join them together.
